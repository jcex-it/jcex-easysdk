...
import com.jcex.open.easysdk.util.Base64Util;
...
public class Signature {
    ...
    public static String checkSignAndDecrypt(Map<String, String> params, String alipayPublicKey,
        ...
        if (isCheckSign) {
            if (!rsaCheckV2(params, alipayPublicKey, charset)) {
                throw new SignException("rsaCheck failure:rsaParams=" + params);
            }
        }
    ...
    public static String rsaEncrypt(String content, String publicKey,
        ...
        try {
            ...
            throw new SignException("EncryptContent = " + content + ",charset = " + charset,
                e);
        }
    }
    ...
    public static String rsaDecrypt(String content, String privateKey,
        ...
        try {
            ...
            throw new SignException("EncodeContent = " + content + ",charset = " + charset, e);
        }
    }
